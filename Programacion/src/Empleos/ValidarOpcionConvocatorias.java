...
public class ValidarOpcionConvocatorias {
	WebDriver driver;
	...
	{	
		...
		//Seleccionar opción Convocatorias
		driver.findElement(By.xpath("//*[@id=\"content\"]/div/div/div/div/div/section[2]/div/div/div[2]/div/div/div/div/div")).click();
	}
